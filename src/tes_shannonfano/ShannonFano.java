...
public class ShannonFano {
    ...
    public ShannonFano(String str, HashMap<Character, Double> probability) {
		super();
		originalString = str;
		originalStringLength = str.length();
		...
		for (Character c : originalString.toCharArray()) {
			checkPoint = probability.get(c);
			characterFrequency.put(c, originalStringLength * probability.get(c));
		}
